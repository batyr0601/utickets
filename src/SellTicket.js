...
function SellTicket() {
    ...
    return (
        <div className='App'>
            ...
            <form>
                <h3 class='inputLabels'>Event the ticket is for:</h3>
                <TextField class="sellInput" id="outlined-basic nameField" variant="outlined" style={{ margin: "0px 5px", color: "white" }} size="small" value={name}
                    onChange={e => setName(e.target.value)} required />
                <h3 class='inputLabels'>Date of the event:</h3>
                ...
                <h3 class='inputLabels'>Price you are selling for:</h3>
                <TextField class="sellInput" id="outlined-basic" label="i.e. $15" variant="outlined" style={{ margin: "0px 5px" }} size="small" value={price}
                    onChange={e => setPrice(e.target.value)} required />
                <h3 class='inputLabels'>Additional information:</h3>
                <TextField class="sellInput" id="outlined-basic" label="Additional Info" variant="outlined" style={{ margin: "0px 5px" }} size="small" value={info}
            ...
            <Button id = "sellButton" variant="contained" color="primary" onClick={addTicket}>Post your ticket</Button>
